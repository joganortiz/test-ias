...
export class Init1715362207926 implements MigrationInterface {
    name = 'Init1715362207926'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`recipes\` (\`_id\` varchar(36) NOT NULL, \`name\` varchar(55) NOT NULL, \`description\` longtext NOT NULL, \`dificualtad\` enum ('facil', 'medio', 'dificil') NOT NULL DEFAULT 'medio', \`food_id\` varchar(36) NULL, PRIMARY KEY (\`_id\`)) ENGINE=InnoDB`);
